...
const PlayerModal = ({ isShowing, hide, playerInfo }) => {
                ...
                <div className='Model-Item-Content'>
                    ...
                    <ul className='Player-Info-Bio'>
                        ...
                        <div className='Player-Info-Line'>
                            ...
                            <div className='Player-Info-Line-Body'>{playerInfo.pregameRitual}</div>
                        </div>
                        <div className='Player-Info-Line'>
                        ...
                        <div className='Player-Info-Line'>
                            ...
                            <div className='Player-Info-Line-Body'>{playerInfo.fate}</div>
                        </div>
                        <div className='Player-Info-Line'>
                            <div className='Player-Info-Line-Header'>Soulscream</div>
                            <div className='Player-Soulscream'>
                                <div className='Player-Soulscream-Body'>{playerInfo.soulscream}</div>
                            </div>
                        </div>
                    </ul>
                </div>
